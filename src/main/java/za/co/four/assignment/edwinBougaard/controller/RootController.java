package za.co.four.assignment.edwinBougaard.controller;
...
import za.co.four.assignment.edwinBougaard.helper.ValidationCodes;
import za.co.four.assignment.edwinBougaard.model.ShortestPathModel;
...
public class RootController {
    ...
    public String addVertex(Model model) {
        model.addAttribute("vertex", new Planet());
        return "vertexadd";
    }

    @RequestMapping(value = "vertex", method = RequestMethod.POST)
    public String saveVertex(Planet vertex, Model model) {
    ...
    public String updateVertex(Planet vertex) {
    ...
    public String addEdge(Model model) {
        ...
        List allVertices = entityManagerService.getAllVertices();
        model.addAttribute("edge", new Speed());
    ...
    public String saveEdge(Speed edge, @ModelAttribute ShortestPathModel pathModel, Model model) {
    ...
    public String editEdge(@PathVariable long recordId, Model model) {
        ...
        List allVertices = entityManagerService.getAllVertices();
        Speed edgeToEdit = entityManagerService.getEdgeById(recordId);
    ...
    public String updateEdge(Speed edge, @ModelAttribute ShortestPathModel pathModel, Model model) {
        edge.setSource(pathModel.getSourceVertex());
        edge.setDestination(pathModel.getDestinationVertex());
        if (pathModel.getSourceVertex().equals(pathModel.getDestinationVertex())) {
            buildEdgeValidation(pathModel, model, ValidationCodes.ROUTE_TO_SELF.toString());
    ...
    public String shortestSubmit(@ModelAttribute ShortestPathModel pathModel, Model model) {
        ...
        Planet source = entityManagerService.getVertexByName(pathModel.getVertexName());
        Planet destination = entityManagerService.getVertexById(pathModel.getSelectedVertex());
        //
