...
public class XLSXHandler {
    ...
    public List<Planet> readVertexes() {
        List<Planet> vertices = new ArrayList<>();
        try {
    ...
    public List<Speed> readEdges() {
        List<Speed> edges = new ArrayList<>();
        try {
            FileInputStream inputStream = new FileInputStream(this.file);
